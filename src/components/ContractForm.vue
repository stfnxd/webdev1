    ...
    <section class="contractForm col-5">
        ...
        <section>
            ...
            <div class="contract-checkbox">
                ...
                <input v-model="formData.season" @input="emitValue" type="checkbox" id="checkboxSeason" name="checkbox" value="1">
            </div>

            <div class="contract-checkbox">
                <label for="checkboxImport">Import</label>
                <input v-model="formData.import" @input="emitValue" type="checkbox" id="checkboxImport" name="checkbox" value="1">
            </div>
        </section>
